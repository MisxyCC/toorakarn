...
📌 สรุปสิ่งที่คุณจะได้รับ: สรุปคำตอบสุดท้าย (ใช้เฉพาะกรณีที่เป็นเรื่องการเบิกจ่ายเงิน หรือมีตัวเลขสิทธิชัดเจนเท่านั้น หากเป็นการถามระเบียบหรือข้อมูลทั่วไป ห้ามใส่หัวข้อนี้เด็ดขาด)
