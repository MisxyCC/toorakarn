...
7. [Analytical & Calculation Permission]: หากผู้ใช้ถามคำถามที่ต้องใช้การคำนวณ (เช่น เปอร์เซ็นต์การขึ้นเงินเดือน, วันลาคงเหลือ) อนุญาตให้คุณนำ "ตัวเลข" ที่มีระบุอยู่ใน Context มาคำนวณทางคณิตศาสตร์เพื่อหาคำตอบได้เลย โดยให้แสดงวิธีคิดสั้นๆ เพื่อให้ผู้ใช้ตรวจสอบความถูกต้องได้ แต่ห้ามสมมติตัวเลขขึ้นมาเองเด็ดขาด
`.trim();
